...
for tstep=0:te
   ...
   E1 = E1*lUnits/tUnits*lUnits/tUnits*dUnits;
   E2 = double(hdf5read(hdfile,'Grid00000001/Radiation_Energy2'));
   E2 = E2*lUnits/tUnits*lUnits/tUnits*dUnits;
   E3 = double(hdf5read(hdfile,'Grid00000001/Radiation_Energy3'));
   E3 = E3*lUnits/tUnits*lUnits/tUnits*dUnits;
...
%      axis([0, 4.5, -0.2, 1.2]);  grid on
	 ...
	 saveas(h,'HIcontour_1000Myr.png');
      ...
      set(gca,'FontSize',14);
      if (Myr0)
	 saveas(h,'Efcontour_0Myr.fig');
	 saveas(h,'Efcontour_0Myr.eps','epsc');
	 saveas(h,'Efcontour_0Myr.png');
      elseif (Myr10)
	 saveas(h,'Efcontour_10Myr.fig');
	 saveas(h,'Efcontour_10Myr.eps','epsc');
	 saveas(h,'Efcontour_10Myr.png');
      elseif (Myr30)
	 saveas(h,'Efcontour_30Myr.fig');
	 saveas(h,'Efcontour_30Myr.eps','epsc');
	 saveas(h,'Efcontour_30Myr.png');
      elseif (Myr100)
	 saveas(h,'Efcontour_100Myr.fig');
	 saveas(h,'Efcontour_100Myr.eps','epsc');
	 saveas(h,'Efcontour_100Myr.png');
      elseif (Myr200)
	 saveas(h,'Efcontour_200Myr.fig');
	 saveas(h,'Efcontour_200Myr.eps','epsc');
	 saveas(h,'Efcontour_200Myr.png');
      elseif (Myr500)
	 saveas(h,'Efcontour_500Myr.fig');
	 saveas(h,'Efcontour_500Myr.eps','epsc');
	 saveas(h,'Efcontour_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'Efcontour_1000Myr.fig');
	 saveas(h,'Efcontour_1000Myr.eps','epsc');
	 saveas(h,'Efcontour_1000Myr.png');
      end
      ...
      set(gca,'FontSize',14);
      if (Myr0)
	 saveas(h,'E1contour_0Myr.fig');
	 saveas(h,'E1contour_0Myr.eps','epsc');
	 saveas(h,'E1contour_0Myr.png');
      elseif (Myr10)
	 saveas(h,'E1contour_10Myr.fig');
	 saveas(h,'E1contour_10Myr.eps','epsc');
	 saveas(h,'E1contour_10Myr.png');
      elseif (Myr30)
	 saveas(h,'E1contour_30Myr.fig');
	 saveas(h,'E1contour_30Myr.eps','epsc');
	 saveas(h,'E1contour_30Myr.png');
      elseif (Myr100)
	 saveas(h,'E1contour_100Myr.fig');
	 saveas(h,'E1contour_100Myr.eps','epsc');
	 saveas(h,'E1contour_100Myr.png');
      elseif (Myr200)
	 saveas(h,'E1contour_200Myr.fig');
	 saveas(h,'E1contour_200Myr.eps','epsc');
	 saveas(h,'E1contour_200Myr.png');
      elseif (Myr500)
	 saveas(h,'E1contour_500Myr.fig');
	 saveas(h,'E1contour_500Myr.eps','epsc');
	 saveas(h,'E1contour_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'E1contour_1000Myr.fig');
	 saveas(h,'E1contour_1000Myr.eps','epsc');
	 saveas(h,'E1contour_1000Myr.png');
      end
      ...
      set(gca,'FontSize',14);
      if (Myr0)
	 saveas(h,'E2contour_0Myr.fig');
	 saveas(h,'E2contour_0Myr.eps','epsc');
	 saveas(h,'E2contour_0Myr.png');
      elseif (Myr10)
	 saveas(h,'E2contour_10Myr.fig');
	 saveas(h,'E2contour_10Myr.eps','epsc');
	 saveas(h,'E2contour_10Myr.png');
      elseif (Myr30)
	 saveas(h,'E2contour_30Myr.fig');
	 saveas(h,'E2contour_30Myr.eps','epsc');
	 saveas(h,'E2contour_30Myr.png');
      elseif (Myr100)
	 saveas(h,'E2contour_100Myr.fig');
	 saveas(h,'E2contour_100Myr.eps','epsc');
	 saveas(h,'E2contour_100Myr.png');
      elseif (Myr200)
	 saveas(h,'E2contour_200Myr.fig');
	 saveas(h,'E2contour_200Myr.eps','epsc');
	 saveas(h,'E2contour_200Myr.png');
      elseif (Myr500)
	 saveas(h,'E2contour_500Myr.fig');
	 saveas(h,'E2contour_500Myr.eps','epsc');
	 saveas(h,'E2contour_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'E2contour_1000Myr.fig');
	 saveas(h,'E2contour_1000Myr.eps','epsc');
	 saveas(h,'E2contour_1000Myr.png');
      end
      ...
      set(gca,'FontSize',14);
      if (Myr0)
	 saveas(h,'E3contour_0Myr.fig');
	 saveas(h,'E3contour_0Myr.eps','epsc');
	 saveas(h,'E3contour_0Myr.png');
      elseif (Myr10)
	 saveas(h,'E3contour_10Myr.fig');
	 saveas(h,'E3contour_10Myr.eps','epsc');
	 saveas(h,'E3contour_10Myr.png');
      elseif (Myr30)
	 saveas(h,'E3contour_30Myr.fig');
	 saveas(h,'E3contour_30Myr.eps','epsc');
	 saveas(h,'E3contour_30Myr.png');
      elseif (Myr100)
	 saveas(h,'E3contour_100Myr.fig');
	 saveas(h,'E3contour_100Myr.eps','epsc');
	 saveas(h,'E3contour_100Myr.png');
      elseif (Myr200)
	 saveas(h,'E3contour_200Myr.fig');
	 saveas(h,'E3contour_200Myr.eps','epsc');
	 saveas(h,'E3contour_200Myr.png');
      elseif (Myr500)
	 saveas(h,'E3contour_500Myr.fig');
	 saveas(h,'E3contour_500Myr.eps','epsc');
	 saveas(h,'E3contour_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'E3contour_1000Myr.fig');
	 saveas(h,'E3contour_1000Myr.eps','epsc');
	 saveas(h,'E3contour_1000Myr.png');
      end
...
%      axis([0, 1.2, 1e-7, 10]);  grid on
	 ...
	 saveas(h,'TempProfile_1000Myr.png');
      ...
      grid on
      if (Myr0)
	 saveas(h,'EfProfile_0Myr.fig');
	 saveas(h,'EfProfile_0Myr.eps','epsc');
	 saveas(h,'EfProfile_0Myr.png');
      elseif (Myr10)
	 saveas(h,'EfProfile_10Myr.fig');
	 saveas(h,'EfProfile_10Myr.eps','epsc');
	 saveas(h,'EfProfile_10Myr.png');
      elseif (Myr30)
	 saveas(h,'EfProfile_30Myr.fig');
	 saveas(h,'EfProfile_30Myr.eps','epsc');
	 saveas(h,'EfProfile_30Myr.png');
      elseif (Myr100)
	 saveas(h,'EfProfile_100Myr.fig');
	 saveas(h,'EfProfile_100Myr.eps','epsc');
	 saveas(h,'EfProfile_100Myr.png');
      elseif (Myr200)
	 saveas(h,'EfProfile_200Myr.fig');
	 saveas(h,'EfProfile_200Myr.eps','epsc');
	 saveas(h,'EfProfile_200Myr.png');
      elseif (Myr500)
	 saveas(h,'EfProfile_500Myr.fig');
	 saveas(h,'EfProfile_500Myr.eps','epsc');
	 saveas(h,'EfProfile_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'EfProfile_1000Myr.fig');
	 saveas(h,'EfProfile_1000Myr.eps','epsc');
	 saveas(h,'EfProfile_1000Myr.png');
      end
      ...
      grid on
      if (Myr0)
	 saveas(h,'E1Profile_0Myr.fig');
	 saveas(h,'E1Profile_0Myr.eps','epsc');
	 saveas(h,'E1Profile_0Myr.png');
      elseif (Myr10)
	 saveas(h,'E1Profile_10Myr.fig');
	 saveas(h,'E1Profile_10Myr.eps','epsc');
	 saveas(h,'E1Profile_10Myr.png');
      elseif (Myr30)
	 saveas(h,'E1Profile_30Myr.fig');
	 saveas(h,'E1Profile_30Myr.eps','epsc');
	 saveas(h,'E1Profile_30Myr.png');
      elseif (Myr100)
	 saveas(h,'E1Profile_100Myr.fig');
	 saveas(h,'E1Profile_100Myr.eps','epsc');
	 saveas(h,'E1Profile_100Myr.png');
      elseif (Myr200)
	 saveas(h,'E1Profile_200Myr.fig');
	 saveas(h,'E1Profile_200Myr.eps','epsc');
	 saveas(h,'E1Profile_200Myr.png');
      elseif (Myr500)
	 saveas(h,'E1Profile_500Myr.fig');
	 saveas(h,'E1Profile_500Myr.eps','epsc');
	 saveas(h,'E1Profile_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'E1Profile_1000Myr.fig');
	 saveas(h,'E1Profile_1000Myr.eps','epsc');
	 saveas(h,'E1Profile_1000Myr.png');
      end
      ...
      grid on
      if (Myr0)
	 saveas(h,'E2Profile_0Myr.fig');
	 saveas(h,'E2Profile_0Myr.eps','epsc');
	 saveas(h,'E2Profile_0Myr.png');
      elseif (Myr10)
	 saveas(h,'E2Profile_10Myr.fig');
	 saveas(h,'E2Profile_10Myr.eps','epsc');
	 saveas(h,'E2Profile_10Myr.png');
      elseif (Myr30)
	 saveas(h,'E2Profile_30Myr.fig');
	 saveas(h,'E2Profile_30Myr.eps','epsc');
	 saveas(h,'E2Profile_30Myr.png');
      elseif (Myr100)
	 saveas(h,'E2Profile_100Myr.fig');
	 saveas(h,'E2Profile_100Myr.eps','epsc');
	 saveas(h,'E2Profile_100Myr.png');
      elseif (Myr200)
	 saveas(h,'E2Profile_200Myr.fig');
	 saveas(h,'E2Profile_200Myr.eps','epsc');
	 saveas(h,'E2Profile_200Myr.png');
      elseif (Myr500)
	 saveas(h,'E2Profile_500Myr.fig');
	 saveas(h,'E2Profile_500Myr.eps','epsc');
	 saveas(h,'E2Profile_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'E2Profile_1000Myr.fig');
	 saveas(h,'E2Profile_1000Myr.eps','epsc');
	 saveas(h,'E2Profile_1000Myr.png');
      end
      ...
      grid on
      if (Myr0)
	 saveas(h,'E3Profile_0Myr.fig');
	 saveas(h,'E3Profile_0Myr.eps','epsc');
	 saveas(h,'E3Profile_0Myr.png');
      elseif (Myr10)
	 saveas(h,'E3Profile_10Myr.fig');
	 saveas(h,'E3Profile_10Myr.eps','epsc');
	 saveas(h,'E3Profile_10Myr.png');
      elseif (Myr30)
	 saveas(h,'E3Profile_30Myr.fig');
	 saveas(h,'E3Profile_30Myr.eps','epsc');
	 saveas(h,'E3Profile_30Myr.png');
      elseif (Myr100)
	 saveas(h,'E3Profile_100Myr.fig');
	 saveas(h,'E3Profile_100Myr.eps','epsc');
	 saveas(h,'E3Profile_100Myr.png');
      elseif (Myr200)
	 saveas(h,'E3Profile_200Myr.fig');
	 saveas(h,'E3Profile_200Myr.eps','epsc');
	 saveas(h,'E3Profile_200Myr.png');
      elseif (Myr500)
	 saveas(h,'E3Profile_500Myr.fig');
	 saveas(h,'E3Profile_500Myr.eps','epsc');
	 saveas(h,'E3Profile_500Myr.png');
      elseif (Myr1000)
	 saveas(h,'E3Profile_1000Myr.fig');
	 saveas(h,'E3Profile_1000Myr.eps','epsc');
	 saveas(h,'E3Profile_1000Myr.png');
      end
