// $Id: newgrav-grid.h 19 2010-03-19 23:04:28Z jbordner $
...
class Grid
{
  ...
  /// @class    Grid
  /// @brief    Grid class for representing a grid patch in an AMR hierarchy
  ///
...
class ItGridNeighbors
{
  ...
  /// @class    ItGridNeighbors
  /// @date     2007-05-02
  /// @brief    Class for iterating over all neighboring Grids of a Grid
  ///
  /// Example usage:
  ///
  /// @verbatim
  ...
  ///
  ///     while ((Grid * neighbor = it_neighbors++)) {
  ///        neighbor->print();
  ///     }
  /// @endverbatim
...
class ItGridChildren
{
  ...
  /// @class    ItGridChildren
  /// @date     2007-05-02
  /// @brief    Class for iterating over all child Grids of a Grid
  ///
  /// Example usage:
  ///
  /// @verbatim
