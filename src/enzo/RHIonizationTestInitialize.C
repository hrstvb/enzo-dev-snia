			       ...
			       TopGridData &MetaData, int local)
{
  ...
  const char config_rad_hydro_ionization_test_defaults[] = 
  "### RAD HYDRO IONIZATION TEST DEFAULTS ###\n"
  "\n"
  "Problem: {\n"
  "    RadHydro: {\n"
  ...
  Param.Update(config_rad_hydro_ionization_test_defaults);
  ...
  if (MetaData.RadHydroParameterFname != NULL) {
    ...
    if ((RHfptr = fopen(MetaData.RadHydroParameterFname, "r")) != NULL) {
      ...
      Param.GetScalar(RadHydroDensity, "Proble.RadHydro.Density");
