...
!
!=======================================================================
subroutine AMRFLDSplit_RadiationSource(Ersrc, time, a, ProbType, ESpectrum, &
...
!!$  write(*,*) 'Entering AMRFLDSplit::RadiationSource routine'
...
!!$  write(*,*) 'RadiationSource: integrated source is ',etaconst
  ...
  return
end subroutine AMRFLDSplit_RadiationSource
!=======================================================================
