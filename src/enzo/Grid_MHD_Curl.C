...
/*
 * A wrapper for MHD_Curl(Start, End, Method)
 * operating on the entire active part of the grid
 * with the specified Method.
 */
int grid::MHD_Curl(int Method){
	return MHD_Curl(GridStartIndex, GridEndIndex, Method);
}
 ...
 * operating on the entire active part of the grid
 * with Method=0:
 * Stores the curl of ElectricField into MagneticField.
 */
int grid::MHD_Curl(){
	return MHD_Curl(0);
}
...
/*
 *  A wrapper for MHD_Curl(Start, End, Method := 2)
 *  operating on the entire active part of the grid
 *  with Method=2:
 *  Stores the difference between the OldMagneticField
 *  and the curl of ElectricField into MagneticField.
 */
int grid::MHD_CurlDiff(){
	return MHD_Curl(2);
}
