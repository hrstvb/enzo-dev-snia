...
!
!=======================================================================
subroutine AMRFLDSplit_SetupSystem(matentries, rhsentries, rhsnorm, E0,   &
     E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn, lUn,   &
     lUn0, rUn, rUn0, nUn, nUn0, rank, dx, dy, dz, BCXl, BCXr, BCYl,      &
     BCYr, BCZl, BCZr, x0s, x0e, x1s, x1e, x2s, x2e, Nx, Ny, Nz, NGxl,    &
...
#include "fortran.def"
  ...
  if (rank == 3) then
     ...
     call AMRFLDSplit_SetupSystem3D(matentries, rhsentries, rhsnorm, E0,    &
          E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn,     &
          lUn, lUn0, rUn, rUn0, nUn, nUn0, dx, dy, dz, BCXl, BCXr, BCYl,    &
          BCYr, BCZl, BCZr, x0s, x0e, x1s, x1e, x2s, x2e, Nx, Ny, Nz, NGxl, &
          NGxr, NGyl, NGyr, NGzl, NGzr, xlface, xrface, ylface, yrface,     &
          zlface, zrface, ier)
  ...
  elseif (rank == 2) then
     ...
     call AMRFLDSplit_SetupSystem2D(matentries, rhsentries, rhsnorm, E0,   &
          E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn,    &
          lUn, lUn0, rUn, rUn0, nUn, nUn0, dx, dy, BCXl, BCXr, BCYl, BCYr, &
          x0s, x0e, x1s, x1e, Nx, Ny, NGxl, NGxr, NGyl, NGyr, xlface,      &
          xrface, ylface, yrface, ier)

  elseif (rank == 1) then

     call AMRFLDSplit_SetupSystem1D(matentries, rhsentries, rhsnorm, E0,  &
          E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn,   &
          lUn, lUn0, rUn, rUn0, nUn, nUn0, dx, BCXl, BCXr, x0s, x0e, Nx,  &
          NGxl, NGxr, xlface, xrface, ier)

  else
     write(0,*) 'AMRFLDSplit_SetupSystem error: illegal rank =',rank
  end if

end subroutine AMRFLDSplit_SetupSystem
!=======================================================================
...
subroutine AMRFLDSplit_SetupSystem3D(matentries, rhsentries, rhsnorm, E0, &
     E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn, lUn,   &
...
#include "fortran.def"
  ...
  ! locals
  integer :: i, j, k
  real*8  :: dtfac, dtfac0, kap, kap0, c
...
!!$           D0_zr = c*(2.d0*kap0+R0)/(6.d0*kap0*kap0+3.d0*kap0*R0+R0*R0)
  ...
  return
end subroutine AMRFLDSplit_SetupSystem3D
!=======================================================================
...
subroutine AMRFLDSplit_SetupSystem2D(matentries, rhsentries, rhsnorm, E0, &
     E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn, lUn,   &
...
!!$        D0_yr = c*(2.d0*kap0+R0)/(6.d0*kap0*kap0+3.d0*kap0*R0+R0*R0)
  ...
  return
end subroutine AMRFLDSplit_SetupSystem2D
!=======================================================================
...
subroutine AMRFLDSplit_SetupSystem1D(matentries, rhsentries, rhsnorm, E0, &
     E, kappa, src, dt, a, a0, adot, adot0, ESpectrum, theta, aUn, lUn,   &
...
#include "fortran.def"
  ...
  real,     intent(in) :: aUn, lUn, lUn0, rUn, rUn0, nUn, nUn0
  real, dimension(1-NGxl:Nx+NGxr), intent(in) :: E0, E, src, kappa
...
!!$     D0_xr = c*(2.d0*kap0+R0)/(6.d0*kap0*kap0+3.d0*kap0*R0+R0*R0)
  ...
  return
end subroutine AMRFLDSplit_SetupSystem1D
!=======================================================================
