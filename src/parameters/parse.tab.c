...
{
      29,     0,    -1,    -1,    29,    30,    -1,    33,    31,    -1,
      21,    32,    22,    -1,    21,    32,    23,    22,    -1,    35,
      -1,    32,    23,    35,    -1,    30,    -1,    32,    23,    30,
      -1,     4,    -1,     4,    -1,    34,    24,    36,    -1,     3,
      -1,     7,    -1,     6,    -1,     8,    -1,    37,    -1,    38,
      40,    39,    -1,    38,    39,    -1,    25,    -1,    26,    -1,
      36,    -1,    -1,    40,    27,    36,    41,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   351,   351,   352,   356,   359,   360,   363,   364,   365,
     366,   370,   373,   376,   380,   381,   382,   383,   384,   387,
     388,   391,   398,   402,   403,   403
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'<'", "'>'", "'+'", "'-'", "'*'", "'/'", "'{'", "'}'", "';'", "'='",
  "'['", "']'", "','", "$accept", "file", "group", "parameter_group",
  "parameter_list", "group_name", "parameter_name", "parameter_assignment",
...
{
     -21,    12,   -21,   -21,   -21,   -20,    10,   -21,     0,   -21,
      -5,     5,   -21,   -21,    -2,     3,   -21,   -21,   -21,   -21,
...
{
      19,     6,     8,    20,    21,    22,    19,     9,    28,    20,
      21,    22,     2,    33,     8,    17,     3,    13,    14,    32,
      16,    18,    23,    27,   -12,    27,    31,     0,    23,    15
};

static const yytype_int8 yycheck[] =
{
       3,    21,     4,     6,     7,     8,     3,     6,    26,     6,
       7,     8,     0,    31,     4,    14,     4,    22,    23,    30,
      22,    14,    25,    26,    24,    26,    27,    -1,    25,    24
};
...
{
       0,    29,     0,     4,    30,    33,    21,    31,     4,    30,
      32,    34,    35,    22,    23,    24,    22,    30,    35,     3,
       6,     7,     8,    25,    36,    37,    38,    26,    36,    39,
      40,    27,    39,    36,    41
};
