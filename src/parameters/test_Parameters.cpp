// $Id: test_Parameters.cpp 2172 2011-04-03 19:08:00Z bordner $
...
#define MACH_EPS 1e-15 /* approximate machine epsilon for double precision */
#define CLOSE(a,b) ( fabs((a)-(b)) / (a) < 2*MACH_EPS )
...
void generate_input()
{
  ...
  fp << "GroupCount {\n";
  fp << "   group_1 {blah = 1};\n";
  fp << "   group_2 {blahblah = 2};\n";
  fp << "   group_3 {hmmm = -3.141};\n";
  fp << "}\n";
...
int main()
{
  ...
  // parameters->evalu<ate_scalar("num2",3,values_scalar,deflts_scalar,x,y,z,t);
  ...
  parameters->set_group(0,"GroupCount");
